...
public interface ISysConfigService
{
    ...
    boolean insertConfig(String key, String val, String confName, String createBy);
    /**
     * 根据key与oldVal匹配，如果能匹配上，将值修改为newVal
     */
    boolean updateConfigByKV(String key, String newVal, String oldVal, String updateBy);
