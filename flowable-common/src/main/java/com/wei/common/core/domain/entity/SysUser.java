package com.wei.common.core.domain.entity;
...
import com.wei.common.annotation.Excel;
...
import com.wei.common.core.domain.BaseEntity;
...
public class SysUser extends BaseEntity
{
    ...
    /** 最近登录IP */
    @Excel(name = "最近登录IP", type = Type.EXPORT)
    ...
    public String getWeComNo() {
        return weComNo;
    }

    public void setWeComNo(String weComNo) {
        this.weComNo = weComNo;
    }
