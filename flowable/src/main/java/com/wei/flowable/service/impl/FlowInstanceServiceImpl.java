...
import com.wei.flowable.service.IFlowInstanceService;
...
public class FlowInstanceServiceImpl extends FlowServiceFactory implements IFlowInstanceService {
    ...
    public void delete(String instanceId, String deleteReason) {
        // 查询历史数据
        HistoricProcessInstance hisProcIns = getHistoricProcessInstanceById(instanceId);
        if (hisProcIns.getEndTime() != null) {
            historyService.deleteHistoricProcessInstance(hisProcIns.getId());
            return;
        }
        // 删除流程实例
    ...
    public HistoricProcessInstance getHistoricProcessInstanceById(String processInstanceId) {
        HistoricProcessInstance hisProcIns =
